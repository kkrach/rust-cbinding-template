...
pub const zoo_ZOO_A: zoo = 10;
pub const zoo_ZOO_B: zoo = 11;
pub const zoo_ZOO_C: zoo = 12;
pub const zoo_ZOO_D: zoo = 13;
pub type zoo = ::std::os::raw::c_uint;
extern "C" {
    pub fn foo_reset();
}
extern "C" {
    pub fn foo_get_value() -> zoo;
}
extern "C" {
    pub fn foo_set_value(value: zoo);
}
